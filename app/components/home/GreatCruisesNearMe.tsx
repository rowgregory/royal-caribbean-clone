...
const GreatCruisesNearMe = () => {
  return (
    <div className="max-w-[1920px] px-4 md:px-12 xl:px-[190px] relative w-full mx-auto mb-40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-10">
        {cruisesNearMeData.map((cruise: any, i: number) => (
          <Link href="/cruises" className="relative" key={i}>
            <div className="relative w-full">
              <Image
                src={cruise.image}
                alt="Cruise near me"
                className="aspect-square md:aspect-auto w-full h-auto rounded-md"
                width="0"
                height="0"
                sizes="100vw"
                priority={true}
